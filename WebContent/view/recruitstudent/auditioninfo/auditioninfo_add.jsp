...
<form action="auditioninfo/add.do" method="post" class="form-horizontal">
	...
	<div class="row">
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		 <input type="text" name="auditionTime" onClick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="请输入试听时间"/>
                </div>
            </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">描述</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<textarea name="auditionDesc" class="form-control"></textarea>
                </div>
            </div>
