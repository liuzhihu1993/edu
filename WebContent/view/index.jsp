<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,com.fh.po.*,com.fh.system.dto.*"%>
<%
				...
				<!-- 	<li class="green"><a data-toggle="dropdown"
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="out.do"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="view/bootm.jsp" target="mainframe">
			    ...
			    <a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> <%=dto.getAnth().getAnthortyName() %> </span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							<%List<AnthortyInfo> list = dto.getList();
							if(list!=null&& list.size()>0){
								for(AnthortyInfo anthinfo:list){
							%>
                            <li><a href="<%=anthinfo.getAnthortyUrl() %>" target="mainframe"> <i
									class="icon-double-angle-right"></i> <%=anthinfo.getAnthortyName() %>
							</a></li>
                    		<%}} %>
