	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="communicateId" value="${commum.communicateId }" readonly="readonly" class="form-control input-sm" placeholder="请输入编号"/>
                </div>
            </div>
    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="communicateTime" value='<fmt:formatDate value="${commum.communicateTime }"/>' onclick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="请输入沟通时间"/>
                </div>
            </div>
        </div>
