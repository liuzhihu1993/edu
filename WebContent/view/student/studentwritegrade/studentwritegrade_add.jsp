	...
	<div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="writeGrade"  class="form-control input-sm" placeholder="请输入科目"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="writeGradeTime" onclick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="请输入考试日期"/>
                </div>
            </div>
        </div>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
              ...
              <a class="btn btn-warning" href="studentwritegrade/list.do">返回上一级</a>
        </div>
    </div>
</form>
</body>
