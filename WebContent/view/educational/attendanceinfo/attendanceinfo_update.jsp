	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" readonly="readonly" value="${attendance.attendanceId }" name="attendanceId" class="form-control input-sm" placeholder="请输入编号"/>
                </div>
            </div>
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="attendanceState" value="${attendance.attendanceState }"  class="form-control input-sm" placeholder="请输入状态"/>
                </div>
            </div>
        </div>
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		 <input type="text" name="attendanceTime" onclick="WdatePicker()" readonly="readonly" value='<fmt:formatDate value="${attendance.attendanceTime }"/>' class="form-control input-sm" placeholder="请输入日期"/>
                </div>
            </div>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
              ...
              <a class="btn btn-warning" href="attendanceinfo/list.do">返回上一级</a>
        </div>
    </div>
</form>
