...
<form action="teacher/list.do" method="post" class="form-horizontal">
    ...
    <input type="button"   class="btn btn-success"   value="添加" onClick="javascript:window.location='view/classinfo/teacher/teacher_add.jsp'"/>
    </form>
</div>
<div align="center">
...
<div class="row" style="padding:15px; padding-top:0px; " align="right">
	<display:table class="table  table-condensed table-striped" name="list"  pagesize="10" requestURI="teacher/list.do">
		<display:column property="staffId" title="编号"/>
		<display:column href="teacher/show.do"  paramId="staffId" paramProperty="staffId" property="staffName" title="姓名"/>
		...
		<display:column href="teacher/load.do" paramId="staffId" paramProperty="staffId" value="修改"  title="修改"/>
		<display:column href="teacher/delete.do"  paramId="staffId" paramProperty="staffId" value="删除"  title="删除"/>
	</display:table>
</div>
</body>
</html>